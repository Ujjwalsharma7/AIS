...
const Footer = ({ className = "", propMarginTop }) => {
  ...
  return (
    <div
      className={`self-stretch bg-brown-100 flex flex-col items-start justify-start pt-[39px] pb-[29px] pr-[60px] pl-[61px] box-border gap-[9px] max-w-full mt-[-447.9px] text-left text-43xl text-white font-inter lg:pl-[30px] lg:pr-[30px] lg:box-border mq825:pb-5 mq825:box-border ${className}`}
      style={footerStyle}
    >
      ...
      <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[35.5px] max-w-full font-harmattan mq825:gap-[18px]">
        <b className="relative leading-[140.97%] z-[1] mq825:text-31xl mq825:leading-[70px] mq450:text-18xl mq450:leading-[52px]">
          Reach Us
        </b>
      ...
      <div className="flex flex-row items-start justify-start pt-0 px-0.5 pb-[26px] box-border max-w-full text-12xl">
        <div className="relative leading-[164%] z-[1] mq825:text-6xl mq825:leading-[41px] mq450:text-lgi mq450:leading-[31px]">
          <p className="m-0">
